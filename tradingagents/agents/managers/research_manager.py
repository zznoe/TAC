...
请用中文撰写所有分析内容和建议。"""
        ...
        # response is an InvestmentDecision Pydantic object
        response_json = response.model_dump_json()

        logger.info(f"⏱️ [Research Manager] LLM调用耗时: {elapsed_time:.2f}秒")
        logger.info(f"📊 [Research Manager] 响应输出: {response_json}")

        new_investment_debate_state = {
            "judge_decision": response_json,
